...
use crate::common::extract_reasoning_field_text;
use crate::common::split_leading_think_block;
use crate::common::strip_leading_think_open_tag;
use crate::json_canonical::canonicalize_tool_arguments_str;
use crate::sse::strip_sse_field;
use crate::sse::take_sse_block;
use crate::transform::CodexToolContext;
use crate::transform::chat_usage_to_responses_usage;
use crate::transform::custom_tool_input_from_chat_arguments;
use crate::transform::response_id_from_chat_id;
use crate::transform::response_status_from_finish_reason;
use crate::transform::response_tool_call_item_from_chat_name;
use crate::transform::response_tool_call_item_id_from_chat_name;
use bytes::Bytes;
...
impl ChatToResponsesState {
    ...
    fn handle_chat_chunk(&mut self, chunk: &Value) -> Vec<Bytes> {
        ...
        if let Some(created) = chunk.get("created").and_then(serde_json::Value::as_u64) {
...
mod tests {
    ...
    async fn restores_custom_tool_input_stream_events() {
        ...
        let context = crate::transform::build_codex_tool_context_from_request(&request);
