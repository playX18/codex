...
#[derive(Debug, Parser)]
#[command(bin_name = "codexium plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexium plugin add",
    after_help = "Examples:\n  codexium plugin add sample@debug\n  codexium plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexium plugin list",
    after_help = "Examples:\n  codexium plugin list\n  codexium plugin list --marketplace debug\n  codexium plugin list --json\n  codexium plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexium plugin remove",
    after_help = "Examples:\n  codexium plugin remove sample@debug\n  codexium plugin remove sample --marketplace debug"
)]
