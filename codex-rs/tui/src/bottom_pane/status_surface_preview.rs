...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            ...
            StatusSurfacePreviewItem::TokenThroughput => "42 t/s",
            StatusSurfacePreviewItem::SessionCostEstimate => "~$0.42 est.",
            StatusSurfacePreviewItem::TurnCostEstimate => "~$0.03 turn",
    ...
    pub(crate) fn iter() -> impl Iterator<Item = Self> {
        [
            ...
            Self::SessionCostEstimate,
            Self::TurnCostEstimate,
            Self::SessionId,
            Self::FastMode,
            Self::RawOutput,
            Self::Model,
